...
<div class="table-wrapper">
    <div class="table-title">
        <div class="pull-right">
            <button class="btn btn-default-btn-xs btn-success" data-toggle="modal" data-target="#program"><i
...
@include('dashboard.modal.add_program')
@include('dashboard.modal.update_program')
@endsection
